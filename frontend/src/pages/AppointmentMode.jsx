      ...
      <div className="relative z-10">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div
            onClick={() => {
              setSelected("online");
              setTimeout(() => navigate("/book/online"), 200);
            }}
          ...
          >
            ...
            <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 
                            ...
                            ${selected === "online" ? "scale-110 rotate-3" : "group-hover:scale-105"}`}>
              <Video size={20} />
            </div>
          ...
          <div
            onClick={() => {
              setSelected("offline");
              setTimeout(() => navigate("/book/offline"), 200);
            }}
            className={`p-6 rounded-xl backdrop-blur-md bg-white/70 border 
                        transition-all duration-300 ease-in-out cursor-pointer group
                        ${selected === "offline"
          ...
          >
            ...
            <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 
                            bg-gradient-to-tr from-emerald-500 to-emerald-400 text-white
                            shadow-sm transition-all duration-300
                            ${selected === "offline" ? "scale-110 -rotate-3" : "group-hover:scale-105"}`}>
              <MapPin size={20} />
            </div>
