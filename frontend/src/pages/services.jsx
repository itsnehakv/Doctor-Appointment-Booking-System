...
const Services = () => {
  ...
  // 2. Filter logic (Cleaned up from the conflict)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-100 pt-28 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-xl mx-auto mb-12 relative">
        <div className="flex items-center bg-white rounded-full border-2 border-emerald-300 focus-within:border-emerald-600 transition-all shadow-sm">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredServices.map((service) => (
          ...
          >
            <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-emerald-500 text-white mb-4 group-hover:scale-110 transition">
              {service.icon}
            </div>
