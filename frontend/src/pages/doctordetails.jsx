            ...
            <div className="space-y-4 max-w-[320px] w-full">
              ...
              <div className="group p-4 bg-white/70 backdrop-blur-md rounded-xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xs text-slate-400">{doctor.address}</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-slate-100">
              <div className="bg-white/70 backdrop-blur-md rounded-2xl p-5 shadow-sm flex items-center justify-between gap-6">
                ...
                <button
                  ...
                  className="relative h-12 px-8 rounded-xl overflow-hidden group flex items-center gap-3 transition-all duration-300 shadow-none hover:shadow-[0_0_25px_rgba(16,185,129,0.4)]"
                >
                  ...
                  <div className="relative z-10 bg-white/10 p-2 rounded-lg transition-colors group-hover:bg-white/25">
                    <Calendar size={16} className="text-white" />
                  </div>

                  <span className="relative z-10 text-white text-[11px] font-black uppercase tracking-wider">
                    Book Appointment
                  </span>
                </button>
              </div>
