      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-emerald-100">
            ...
            <li><a href="#" className="footer-link">Online Consultation</a></li>
            <li><a href="#" className="footer-link">Health Checkups</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-emerald-100 mb-4">
            ...
            <li>
              Location: building no 19, 25/1, 9th Cross Rd, Marenahalli, 2nd Phase, J. P. Nagar, Bengaluru, Karnataka 560038
            </li>
          </ul>
          ...
          <div className="flex items-center gap-3 text-emerald-100">
            ...
            {/* X */}
            <a href="#" className="social-icon flex items-center justify-center w-10 h-10 bg-emerald-500/20 rounded-full">
