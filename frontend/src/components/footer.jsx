      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-emerald-100">
            <li><a href="#" className="hover:text-black transition">Find Doctors</a></li>
            <li><a href="#" className="hover:text-black transition">Book Appointment</a></li>
            <li><a href="#" className="hover:text-black transition">Online Consultation</a></li>
            <li><a href="#" className="hover:text-black transition">Health Checkups</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3 text-emerald-100">
            ...
            {/* X */}
            <a href="#" className="flex items-center justify-center w-10 h-10 bg-emerald-500/20 rounded-full hover:bg-white hover:text-emerald-600 transition">
