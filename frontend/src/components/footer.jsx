      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-sm text-emerald-100">
            ...
            making it easy to search, compare, and book appointments anytime. We
            focus on saving your time and making healthcare more accessible.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3 text-emerald-100">
            ...
            <a
              href="#"
              className="social-icon flex items-center justify-center w-10 h-10 bg-emerald-500/20 rounded-full"
            >
              <svg
                width="18"
                height="18"
