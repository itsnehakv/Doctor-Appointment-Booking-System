...
function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between border mx-4 mt-4 max-md:w-full border-stone-200 px-6 py-4 rounded-full text-stone-700 text-sm bg-[#FAFAF9] shadow-sm relative">

      {/* Logo */}
      <div className="flex items-center gap-2">
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" className="text-emerald-600">
          <path d="M4 12h3l2-4 4 8 2-4h3" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
        </svg>
